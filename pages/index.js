...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>WRCSO REGISTRATION</title>
      ...
      <section className="homeregist-section">
        <div className="wrapper">
          <div className="">
            <h2 className="">WRCSO REGISTRATION</h2>
            <h1 className="">Registration WRCSO</h1>
          </div>
        </div>
        ...
        <div className="wrapper">
          ...
          <button
            className="btn btn-custom text-center me-lg-5 m-2"
            onClick={() =>
              handleOpenModal("/internationalparticipants", internationalTerms)
            }
          >
